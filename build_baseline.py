...
server_data = [
    ...
    (1,'Installation','Set a complex password for the administrator',
     'En az 14 karakter, büyük/küçük harf, rakam ve özel karakter içermeli. Varsayılan "Administrator" hesabı yeniden adlandırılmalıdır.',
    ...
    (8,'Password Policy','Enable password policy per "Kullanıcı Kimlik ve Hesap Yönetimi Süreci".',
     'Minimum uzunluk: 14 karakter. Karmaşıklık: Etkin. Maksimum yaş: 90 gün. Geçmiş: 24 şifre. Hesap kilitleme: 5 deneme / 15 dk.',
...
client_data = [
    ...
    (8,'Password Policy','Enable password complexity and enforce history.',
     'Karmaşıklık: Etkin. Minimum uzunluk: 14 karakter. Maksimum yaş: 90 gün. Geçmiş: 24 şifre. Kilitleme: 5 deneme / 15 dk.',
